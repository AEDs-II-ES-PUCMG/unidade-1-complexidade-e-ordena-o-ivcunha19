...
public class App {
    ...
    */
    ...
    static void localizarPedidosPremium() {
        ...
        int i = pedidosOrdenadosPorValor.length/2;
        while (pedidosOrdenadosPorValor[i].valorFinal() < valorCorte || pedidosOrdenadosPorValor[i-1].valorFinal() >= valorCorte) {
            if (pedidosOrdenadosPorValor[i].valorFinal() > valorCorte || pedidosOrdenadosPorValor[i-1].valorFinal() >= valorCorte) {
                i = (int)(i + (i*0.5));
            }else{
                i= (int)(i / 0.5);
            }
        }
        for (int j = i; j < pedidosOrdenadosPorValor.length; j++) {
            pedidosOrdenadosPorValor[j].toString();
        }
